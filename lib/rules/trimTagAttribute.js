...
module.exports = {
	meta: {
		...
		docs: {
			description:
				'Simplify and clean up tag attributes in your code effortlessly, making your HTML cleaner and more maintainable.',
			recommended: false,
			url: 'https://github.com/dilincoln/eslint-plugin-x-trim/blob/main/docs/rules/eslint-plugin-x-trim.md',
		},
		messages: {
